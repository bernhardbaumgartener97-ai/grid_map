#!/usr/bin/env python3
"""Nearfield readiness adapter for the grid_map fork.

This fork-local adapter scores robot evaluation traces for the terrain_and_traversability_evidence
...
PROJECT = {
    "repo": "grid_map",
    "domain": "terrain_and_traversability_evidence",
...
THRESHOLDS = {
    ...
    "max_calibration_rmse_px": 2.2,
    "max_contact_events": 1,
    "min_success_rate": 0.92,
    "min_stability_margin": 0.24
}
